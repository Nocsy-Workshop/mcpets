...
Each pet has a unique config that you can create, modify or delete at "_./plugins/MCPets/Pets/anyfolderyouwant/yourpetconfig.yml_".

Down below you will find the typical pet config template. It has a lot more features than required (indeed, all of them actually), and it's just meant to explain how you could implement them into your config.
